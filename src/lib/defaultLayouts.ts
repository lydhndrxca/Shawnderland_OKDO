...
const PROPLAB_DEFAULT: LayoutSnapshot = {
  nodes: [
    ...
    { id: "pl-def-10", position: { x: 1180, y: 800 }, type: "propFrontViewer", style: { width: 500, height: 720 } },
    ...
    { id: "pl-def-13", position: { x: 2820, y: 800 }, type: "propTopViewer", style: { width: 500, height: 720 } },
    { id: "pl-def-14", position: { x: -1420, y: 600 }, type: "imageInfluence" },
  ...
  edges: [
    ...
    // Main → ortho views
    { id: "e-pl-22", source: "pl-def-09", target: "pl-def-10", sourceHandle: "output", targetHandle: "input" },
    { id: "e-pl-23", source: "pl-def-09", target: "pl-def-11", sourceHandle: "output", targetHandle: "input" },
    { id: "e-pl-24", source: "pl-def-09", target: "pl-def-12", sourceHandle: "output", targetHandle: "input" },
    { id: "e-pl-25", source: "pl-def-09", target: "pl-def-13", sourceHandle: "output", targetHandle: "input" },
    // Ortho views → Hitem3D
    { id: "e-pl-26", source: "pl-def-10", target: "pl-def-19", sourceHandle: "output" },
    { id: "e-pl-27", source: "pl-def-11", target: "pl-def-19", sourceHandle: "output" },
    { id: "e-pl-28", source: "pl-def-12", target: "pl-def-19", sourceHandle: "output" },
    { id: "e-pl-29", source: "pl-def-13", target: "pl-def-19", sourceHandle: "output" },
    // 3D gen → UE3D viewers
