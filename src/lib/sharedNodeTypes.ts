...
export const NODE_DEFAULTS: Record<string, { style?: { width: number; height: number }; data?: Record<string, unknown> }> = {
  ...
  charMainViewer: { style: { width: 600, height: 770 }, data: { viewKey: 'main' } },
  charFrontViewer: { style: { width: 500, height: 790 }, data: { viewKey: 'front' } },
  charBackViewer: { style: { width: 500, height: 790 }, data: { viewKey: 'back' } },
  charSideViewer: { style: { width: 500, height: 790 }, data: { viewKey: 'side' } },
  ...
  charCustomView: { style: { width: 400, height: 790 }, data: { viewKey: 'custom' } },
