"""
Joe Pera LoRA Fine-Tuning for RTX 5090 (32GB VRAM)

Uses Mistral-Nemo 12B as base — same architecture as Serling/Fielder for consistency.
...
Usage:
  ...
  2. python train_pera.py           # fresh start
  3. python train_pera.py --resume   # resume from last checkpoint
...
PAIRS_PATH = SCRIPT_DIR / "pera_pairs.json"
OUTPUT_DIR = SCRIPT_DIR / "pera-lora-adapter"
...
with open(LOG_PATH, mode, encoding="utf-8") as f:
    f.write(f"\n=== Pera LoRA Training Log — {datetime.now()} ===\n")
...
if not PAIRS_PATH.exists():
    log("ERROR: pera_pairs.json not found. Run generate-training-pairs.mjs first.")
    exit(1)
