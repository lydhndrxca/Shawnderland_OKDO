...
const PROPLAB_DEFAULT: LayoutSnapshot = {
  nodes: [
    ...
    { id: "pl-def-19", position: { x: 3000, y: 800 }, type: "designSpec", style: { width: 320, height: 480 } },
    { id: "pl-def-20", position: { x: 3400, y: 2400 }, type: "hitem3dImageTo3D", style: { width: 340, height: 640 } },
    { id: "pl-def-21", position: { x: 3900, y: 1600 }, type: "ue3dViewer", style: { width: 800, height: 780 } },
  ],
  edges: [
    ...
    { id: "e-pl-18", source: "pl-def-09", target: "pl-def-19", sourceHandle: "output", targetHandle: "input" },
    { id: "e-pl-19", source: "pl-def-10", target: "pl-def-19", sourceHandle: "output", targetHandle: "input" },
    { id: "e-pl-20", source: "pl-def-11", target: "pl-def-19", sourceHandle: "output", targetHandle: "input" },
    { id: "e-pl-21", source: "pl-def-12", target: "pl-def-19", sourceHandle: "output", targetHandle: "input" },
    { id: "e-pl-22", source: "pl-def-13", target: "pl-def-19", sourceHandle: "output", targetHandle: "input" },
    { id: "e-pl-23", source: "pl-def-19", target: "pl-def-17", sourceHandle: "output", targetHandle: "input" },
    { id: "e-pl-24", source: "pl-def-19", target: "pl-def-20", sourceHandle: "output", targetHandle: "input" },
    { id: "e-pl-25", source: "pl-def-17", target: "pl-def-21" },
    { id: "e-pl-26", source: "pl-def-20", target: "pl-def-21" },
  ],
  nodeData: {
    "pl-def-05": {
      imageGenModelId: "imagen4-fast",
