"""
Convert Pera LoRA adapter to GGUF format using Python-only tooling.
"""
...
ADAPTER_DIR = SCRIPT_DIR / "pera-lora-adapter"
MERGED_DIR = SCRIPT_DIR / "pera-merged-16bit"
GGUF_DIR = SCRIPT_DIR / "pera-gguf"
CONVERTER = Path.home() / ".unsloth" / "llama.cpp" / "convert_hf_to_gguf.py"
MAX_SEQ_LENGTH = 1024

print("=== Pera LoRA -> GGUF Converter ===\n")
...
gguf_output = GGUF_DIR / "pera-f16.gguf"
