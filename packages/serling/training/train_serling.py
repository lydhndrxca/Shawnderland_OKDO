"""
Rod Serling LoRA Fine-Tuning for RTX 5090 (32GB VRAM)

Uses Mistral-Nemo 12B as base — larger model = better style capture.
...
Usage:
  ...
  2. python train_serling.py           # fresh start
  3. python train_serling.py --resume   # resume from last checkpoint
...
PAIRS_PATH = SCRIPT_DIR / "serling_pairs.json"
OUTPUT_DIR = SCRIPT_DIR / "serling-lora-adapter"
...
with open(LOG_PATH, mode, encoding="utf-8") as f:
    f.write(f"\n=== Serling LoRA Training Log — {datetime.now()} ===\n")
...
if not PAIRS_PATH.exists():
    log("ERROR: serling_pairs.json not found.")
    exit(1)
